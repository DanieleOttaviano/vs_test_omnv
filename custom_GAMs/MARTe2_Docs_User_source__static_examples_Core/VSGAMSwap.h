/**
 * @file VSGAMSwap.h
 * @brief Header file for class VSGAMSwap
 * @date 06/04/2018
 * @author Andre Neto
 *
 ...
 * @details This header file contains the declaration of the class VSGAMSwap
 ...
 * }
 */
class VSGAMSwap : public MARTe::GAM {
public:
...
private:
    ...
    MARTe::float64 *vs3es_ref;
    MARTe::float64 *vs3fpga_ref;
