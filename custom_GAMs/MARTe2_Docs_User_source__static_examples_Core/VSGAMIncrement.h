/**
 * @file VSGAMIncrement.h
 * @brief Header file for class VSGAMIncrement
 * @date 06/04/2018
 * @author Andre Neto
 *
 ...
 * @details This header file contains the declaration of the class VSGAMIncrement
 ...
 * }
 */
class VSGAMIncrement : public MARTe::GAM {
public:
...
private:
     ...
     * The input signals
     */
    MARTe::uint8 *inputCounter;
    MARTe::uint8 *oracleDecision;

    /**
     * The output signal
     */
    MARTe::uint8 *marteStrategy;
    MARTe::uint8 *outputCounter;
