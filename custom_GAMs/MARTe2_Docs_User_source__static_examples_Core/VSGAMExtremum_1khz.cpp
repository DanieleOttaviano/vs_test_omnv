/**
 * @file VSGAMExtremum_1khz.cpp
 * @brief Source file for class VSGAMExtremum_1khz
 * @date 06/04/2018
 * @author Andre Neto
 *
 ...
 * the class VSGAMExtremum_1khz (public, protected, and private). Be aware that some 
...
VSGAMExtremum_1khz::VSGAMExtremum_1khz() {  
    // Input Signals
...
bool VSGAMExtremum_1khz::Initialise(MARTe::StructuredDataI & data) {
...
bool VSGAMExtremum_1khz::Execute() {
...
CLASS_REGISTER(VSGAMExtremum_1khz, "")
}
